                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase">A Fitness</h5>

                            <h1 class="display-2 text-white text-uppercase mb-md-4">Eat Sleep Gym Repeat.</h1>
        ...
        <div class="row gx-5">
            <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded" src="img/aboutt.jpg" style="object-fit: cover;">
                </div>
            </div>
            <div class="col-lg-7">
                <div class="mb-4">
                    <h5 class="text-primary text-uppercase">About Us</h5>
                    <h1 class="display-3 text-uppercase mb-0">Welcome to A Fitness</h1>
                </div>
                <h4 class="text-body mb-4">Work , Train, Athletic</h4>
                <p class="mb-4">A Fitness Has Been The Authority In Fitness Since 1965 Dating Back To The Original A Fitness In Venice, California. It Was The Place For Serious Fitness. Opened Long Before The Modern-Day Health Club Existed, The Original A Fitness Featured Homemade Equipment And A Dedication To Getting Results. It Was An Instant Hit. A FitnessQuickly Became Known As “The Mecca Of Bodybuilding.''</p>
                <div class="rounded bg-dark p-5">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="pills-1">
                            <p class="text-secondary mb-0">A Fitness Has Multiple Awards For Excellence Under Its Belt. A Fitness Has Expanded Its Fitness Profile To Offer All Of The Latest Equipment And Services Making It The Best In The Industry. A Fitness Provides A Comprehensive Approach To The Health And Wellbeing Of Its Members With Certified Trainers And Nutritional Counseling.</p>
                        </div>
                        <div class="tab-pane fade" id="pills-2">
                            <p class="text-secondary mb-0">Known For The Unrivaled Success Of Providing State-Of-The-Art Equipment And Fitness Knowledge With A Globally Proven Fitness Training Module And With Certified Trainers And Nutritional Counseling We Have Had A Comprehensive Approach To The Overall Health And Wellbeing Of The Members. At A Fitness, It’s Not Only About Working Out But Having A Healthy Lifestyle</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-5 gb-5">
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded text-center p-5">
                    ...
                    <p>are you a fitness freak then this is the right place for you.hurry up come join us.</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded text-center p-5">
                    ...
                    <p>we will provide you with the best coaches yo make sure you lift heeavy and right.</p>
                    <a class="text-uppercase" href=""></a>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded text-center p-5">
                    ...
                    <p>Gaining muscle is difficult no worries with our proper diet plan it will be much more easier.</p>
                    <a class="text-uppercase" href=""></a>
                </div>

            </div>
            <div class="col-lg-12 col-md-6 text-center">
                <h1 class="text-uppercase text-light mb-4">30% Discount For This Holi</h1>
                <a href="contact.php" class="btn btn-primary py-3 px-5">Become A Member</a>
            </div>
        </div>
    </div>
    <!-- Programe Start -->
                ...
                <div id="tab-2" class="tab-pane fade p-0">
                    <div class="row g-5">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                <h6 class="text-uppercase text-light mb-3">10.00am - 12.00pm</h6>
                                <h5 class="text-uppercase text-primary">Chest Day</h5>
                                <p class="text-uppercase text-secondary mb-0">Rohit ahire</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex">
                    ...
                    <div class="ps-4">
                        ...
                        <h1 class="display-5 text-white mb-0" data-toggle="counter-up">12450</h1>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex">
                    ...
                    <div class="ps-4">
                        ...
                        <h1 class="display-5 text-white mb-0" data-toggle="counter-up">12102</h1>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="d-flex">
                    ...
                    <div class="ps-4">
                        ...
                        <h1 class="display-5 text-white mb-0" data-toggle="counter-up">10954</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <div class="team-item position-relative">
                    ...
                    <div class="position-absolute start-0 bottom-0 w-100 rounded-bottom text-center p-4" style="background: rgba(34, 36, 41, .9);">
                        <h5 class="text-uppercase text-light">Yash Shimpi</h5>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item position-relative">
                    ...
                    <div class="position-absolute start-0 bottom-0 w-100 rounded-bottom text-center p-4" style="background: rgba(34, 36, 41, .9);">
                        <h5 class="text-uppercase text-light">Paurush Muley</h5>
                        <p class="text-uppercase text-secondary m-0">Trainer</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="team-item position-relative">
                    ...
                    <div class="position-absolute start-0 bottom-0 w-100 rounded-bottom text-center p-4" style="background: rgba(34, 36, 41, .9);">
                        <h5 class="text-uppercase text-light">Omkar Jadhav</h5>
                        <p class="text-uppercase text-secondary m-0">Trainer</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 bg-dark p-5">
                ...
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item">
                        <p class="fs-4 fw-normal text-light mb-4"><i class="fa fa-quote-left text-primary me-3"></i>I was afraid of doing gym but coach yash has trained me very well and now i am feeling very enrgetic and healthy thanks A fitness for that.</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid rounded-circle" src="img/testimonial-1.jpg" alt="">
                            <div class="ps-4">
                                <h5 class="text-uppercase text-light">sakshi Chavan</h5>
                                <span class="text-uppercase text-secondary">Student</span>
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-item">
                        <p class="fs-4 fw-normal text-light mb-4"><i class="fa fa-quote-left text-primary me-3"></i>Its very hard to find a gym in city with all these features under one package and at this affordable prices its like a golden deal and i am lucky.</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid rounded-circle" src="img/testimonial-2.jpg" alt="">
                            <div class="ps-4">
                                <h5 class="text-uppercase text-light">Suraj Raut</h5>
                                <span class="text-uppercase text-secondary">HR Manager</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="blog-item">
                            ...
                            <div class="bg-dark d-flex align-items-center rounded-bottom p-4">
                                ...
                                <a class="h5 text-uppercase text-light" href="">Weight lifting</h4></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="blog-item">
                            <div class="position-relative overflow-hidden rounded-top">
                                <img class="img-fluid" src="img/services/cardio.jpg" alt="">
                            </div>
                            <div class="bg-dark d-flex align-items-center rounded-bottom p-4">
                                
                                <a class="h5 text-uppercase text-light" href="">Cardio</h4></a>
                            </div>
                        </div>
                    </div>
                                        <div class="col-md-4">
                        <div class="blog-item">
                            <div class="position-relative overflow-hidden rounded-top">
                                <img class="img-fluid" src="img/services/zoomba.jpg" alt="">
                            </div>
                            <div class="bg-dark d-flex align-items-center rounded-bottom p-4">
                                
                                <a class="h5 text-uppercase text-light" href="">Zumba</h4></a>
                            </div>
                        </div>
                    </div>
